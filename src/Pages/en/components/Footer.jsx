    ...
    return (
        <footer>
            <div className={styles.footerWrapper}>
                ...
                <div className={styles.footerText} data-translate="joinUs">Join Us</div>
                <div className={styles.footerSocial}>
                    <div id="facebook">
                        <a href="https://www.facebook.com/apetitifood">
                    ...
                    <div id="instagram">
                        <a href="https://www.instagram.com/__apetiti/">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0,0,256,256">
                                <g fill="#ffffff" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{ mixBlendMode: 'normal' }}>
                                    <g transform="scale(5.12,5.12)">
                    ...
                    <div id="linkedin">
                        <a href="https://www.linkedin.com/in/apetiti-food-2b7633347/">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0,0,256,256">
                                <g fill="#ffffff" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none" style={{ mixBlendMode: 'normal' }}>
                                    <g transform="scale(5.12,5.12)">
                ...
                <div className={styles.footerContacts}>
                    <div>
                        <p data-translate="address">Address: Somewhere in the world</p>
                    </div>
                    <div>
                        <p data-translate="ourMobile">Tel: (+995) 555 55 55 55</p>
                    </div>
                    <div>
                        <p data-translate="ourMail">Mail: example@gmail.com</p>
                    </div>
                </div>
            </div>
        </footer>
